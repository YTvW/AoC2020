...
for number in input:
    ...
    for remain in input:
        last = remainder - remain
        total =(number+last+remain)
        if input.count(last) > 0 and input.count(remain) > 0  :
            # print("########################")
            # print("found it")
            # print("number: " + str(number))
            # print("remainder: " + str(remain))
            # print("last: " + str(last))
            # print("check: "+ str(number+last+remain))
            print(str(number*last*remain))
            found = True
            break
            # print("########################")
